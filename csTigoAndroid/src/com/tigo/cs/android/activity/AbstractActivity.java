...
public abstract class AbstractActivity extends Activity {
    ...
    protected void onSetContentViewFinish() {
        ...
        consultas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (verifyDeviceEnabled()) {
                    startActivity(new Intent(AbstractActivity.this, UserDataActivity.class));
                    CsTigoApplication.vibrate(false);
                }
            }
        });
        ...
        mensajes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (verifyDeviceEnabled()) {
                    startActivity(new Intent(AbstractActivity.this, MessageHistoryActivity.class));
                    CsTigoApplication.vibrate(false);
                }
            }
        });
        ...
        opciones.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AbstractActivity.this, PlatformUpdateActivity.class));
                CsTigoApplication.vibrate(false);
            }
        });
    ...
    protected boolean startUserMark() {
        ...
        if (serviceEvent.getRequiresLocation()) {
            entity.setRequiresLocation(serviceEvent.getRequiresLocation());
            if (serviceEvent.getRequiresWait()) {
    ...
    protected void verifyLocation() {
        if (CsTigoApplication.getGlobalParameterHelper().getDeviceEnabled()) {
            ...
            /*
             * el user tiene tigo money instalado no envia tracking ni busca
             * persistentemente
             */
