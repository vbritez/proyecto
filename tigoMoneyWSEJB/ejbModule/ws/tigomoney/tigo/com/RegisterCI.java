...
public class RegisterCI extends BaseRequest{
	...
	public String toString() {
		return "[ci=" + ci + ", birthDate=" + birthDate
				+ ", address=" + address + ", city=" + city + ", frontPhoto="
				+ frontPhoto + ", backPhoto=" + backPhoto + ", consumerID="
				+ consumerID + ", consumerPWD=" + consumerPWD
