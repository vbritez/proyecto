...
<head>
    ...
    <title><fmt:message key="web.client.login.screen.header.CSTigoName" /> - Error 403</title>
    ...
    <div id="container_index">
        <div id="login">
            ...
            <div id="centersmall">
                <div class="title">
                    <p>
                        <img src="${pageContext.request.contextPath}/resources/images/forbidden.png" width="48" height="48" alt="<fmt:message key="web.client.errorpages.title.AccessDenied" />" align="absmiddle" /> <strong><fmt:message key="web.client.errorpages.title.AccessDenied" /></strong>
                    </p>
                </div>
                <div align="center">
