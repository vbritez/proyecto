...
<title><fmt:message key="web.client.login.screen.header.CSTigoName" /> - Error 500</title>
    ...
    <div id="container_index">
        <div id="login">
            ...
            <div id="centersmall">
                <div class="title">
                    <p>
                        <img src="${pageContext.request.contextPath}/resources/images/error.png" width="48" height="48" alt="<fmt:message key="web.client.login.screen.header.CSTigoName" />" align="absmiddle" /> <strong><fmt:message key="web.client.errorPages.title.InternalError" /></strong>
                    </p>
                </div>
                <div align="center">
                    <table class="table_1" width="100%">
                        <tr>
                            <td class="txt_1">
                                <fmt:message key="web.client.errorPages.message.InternalErrorFound" />
                            </td>
                        </tr>
                        <tr>
                            <td class="txt_2" style="padding-bottom: 15px;">
