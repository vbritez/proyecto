...
@ManagedBean(name = "reportAttendanceSumarizedFullBean")
@ViewScoped
@ReportFile(fileName = "rep_attendance_sumarized")
public class ReportAttendanceSumarizedFullBean extends AbstractFullReportBean {

    private static final long serialVersionUID = -590867472448645563L;

    public ReportAttendanceSumarizedFullBean() {
    }
    ...
    public String getReportName() {
        ...
        if ((getSelectedClassificationList() != null
            ...
            reportName = "rep_attendance_sumarized_classification";
        } else {
            reportName = "rep_attendance_sumarized";
        }
